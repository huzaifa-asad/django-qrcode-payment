...
def generate_qr(request):
    ...
    if request.method == 'POST':
        ...
        qr_image_io = BytesIO() # Create bytesIO stream
        qr.save(qr_image_io, format="PNG") # Save the qr_code to qr_image_io
...
def scan_qr(request):
    ...
    if request.method == 'POST' and request.FILES.get('qr_image'):
        ...
        fs = FileSystemStorage(location=settings.MEDIA_ROOT / 'qr_codes', base_url='/media/qr_codes/')
        ...
        try:
            ...
            if decoded_objects:
                ...
                # Check if the data exists in the QRCode model with the
                ...
                if qr_entry and qr_mobile_number == mobile_number:
                    ...
                    result = "Scan Failed: Invalid QR Code ot mobile number mismatch"
            ...
            # Ensure the image is deleted regardless of the result
